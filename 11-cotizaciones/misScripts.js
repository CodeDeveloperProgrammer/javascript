...
async function cargarCotizaciones(callback) {
    ...
    let datos3 = await crearPedido('https://open.er-api.com/v6/latest/GBP');
    document.getElementById('UsdGbp').append(datos3.rates.USD);
...
function cargarElementos() {
    document.getElementById('imgLogo').setAttribute('src', 'bitcoin-dólar-euro-libra-aisló-el-sistema-de-imagen-del-vector-71714615.webp');
    document.getElementById('titulo').textContent = "Cotizaciones Online";
    document.getElementById('imgEspera').setAttribute('src', 'homer.gif');
...
function cargarTextos() {
    ...
    document.getElementById('UsdGbp').append("GBP a USD: ");
